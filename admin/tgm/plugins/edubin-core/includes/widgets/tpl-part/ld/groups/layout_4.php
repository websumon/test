...
?> 
   ...
   <div class="edubin-course layout__<?php echo esc_attr($ld_course_archive_style); ?> <?php echo $ld_review_show ? 'review__show' : ''; ?> col__<?php echo esc_attr($ld_course_archive_clm); ?>">
