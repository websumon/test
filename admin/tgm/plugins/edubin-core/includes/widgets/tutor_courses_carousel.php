...
class Edubin_Elementor_Widget_Tutor_Course_Carousel extends Widget_Base {
    ...
    // 			'condition' => [
        ...
        $this->add_responsive_control(
        	...
        	[
        		...
        		'selectors' => [
        			...
        			'{{WRAPPER}} .edubin-tutor-course .tutor-courses-wrap.style-2 .tutor-course-col .tutor-course' => 'text-align: {{VALUE}};',
        ...
        $this->add_group_control(
        	...
        	[
        		'name' => 'box_shadow',
        		'selector' => '{{WRAPPER}} .edubin-tutor-course .slick-slide, .edubin-tutor-course .tutor-courses-wrap.style-2 .tutor-course-col .tutor-course, .edubin-course',
        	]
        );
		...
		$this->add_group_control(
			...
			'selector' => '{{WRAPPER}} .tutor-loop-course-container:hover, .edubin-tutor-course .tutor-courses-wrap.style-2 .tutor-course-col .tutor-course:hover, .edubin-course:hover',
		]
	);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .edubin-tutor-course .tutor-courses-wrap.style-2 .tutor-course-col .tutor-course' => 'background-color: {{VALUE}}',
